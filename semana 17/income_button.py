...
def income_button(table_list,category_list):
    layout = [
        ...
        [sg.Button('Submit income', key='submit_icm'), sg.Button('Not seeing your category?', key='crt_category')],
        [sg.Button('Exit')]]
